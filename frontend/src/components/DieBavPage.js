  ...
  const benefitsCards = [
    {
      ...
      icon: (
        <div className="w-16 h-16 relative" style={{clipPath: "polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)"}}>
          <div className="w-full h-full bg-[#1a3a52] flex items-center justify-center">
