    ...
    <section className="py-20 md:py-24 overflow-hidden" style={{backgroundColor: '#001f3d'}}>
      <div className="max-w-[1400px] mx-auto px-6 md:px-8">
        ...
        <div className="relative">
          ...
          <div className="absolute left-0 top-0 bottom-0 w-32 bg-gradient-to-r from-[#001f3d] to-transparent z-10 pointer-events-none"></div>
          <div className="absolute right-0 top-0 bottom-0 w-32 bg-gradient-to-l from-[#001f3d] to-transparent z-10 pointer-events-none"></div>
